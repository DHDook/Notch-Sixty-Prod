...
header = r'''#ifndef N60SpectralDenoiser_h
...
source = r'''#include "N60SpectralDenoiser.h"
...
(realtime / 'N60SpectralDenoiser.h').write_text(header)
(realtime / 'N60SpectralDenoiser.c').write_text(source)
...
text = replace_once(
    ...
    '\t\tA30000000000000000000028 /* N60Protection.h */ = {isa = PBXFileReference; lastKnownFileType = sourcecode.c.h; path = N60Protection.h; sourceTree = "<group>"; };\n'
    '\t\tA30000000000000000000029 /* N60SpectralDenoiser.c */ = {isa = PBXFileReference; lastKnownFileType = sourcecode.c.c; path = N60SpectralDenoiser.c; sourceTree = "<group>"; };\n'
...
text = replace_once(
    ...
    '\t\t\t\tA30000000000000000000028 /* N60Protection.h */,\n'
    '\t\t\t\tA30000000000000000000029 /* N60SpectralDenoiser.c */,\n'
    '\t\t\t\tA3000000000000000000002A /* N60SpectralDenoiser.h */,\n',
    'denoiser realtime group')
text = replace_once(
    text,
    '\t\t\t\tA30000000000000000000014 /* N60Protection.c in Sources */,\n',
    '\t\t\t\tA30000000000000000000014 /* N60Protection.c in Sources */,\n'
    '\t\t\t\tA30000000000000000000015 /* N60SpectralDenoiser.c in Sources */,\n',
    'denoiser source phase')
project.write_text(text)

# Swift bridge for validation tests/control plane.
bridge = realtime / 'NotchSixty-Bridging-Header.h'
text = bridge.read_text()
if '#import "N60SpectralDenoiser.h"' not in text:
    text += '\n#import "N60SpectralDenoiser.h"\n'
bridge.write_text(text)

# Standalone deterministic tests. Integration into the product graph follows in the next slice-3 commit.
...
'''
if 'testSpectralDenoiserQualityModesHaveExplicitPowerOfTwoContracts' not in text:
    text += append
