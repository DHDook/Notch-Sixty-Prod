...
| Realtime architecture | Original commercial implementation | Product requirements + realtime design rules | Transport bridge is implemented; RenderKernel/DSP graph remains pending. |
